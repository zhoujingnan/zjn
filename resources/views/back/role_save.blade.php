...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：角色管理&nbsp;&nbsp;>&nbsp;&nbsp;修改角色</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <form action="{{url('/backrole/updo')}}" enctype="multipart/form-data" method="post">
    	...
    	<input type="hidden" name="_token" value="{{csrf_token()}}">
      	<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        	...
        	<td align="left" valign="middle" class="borderright borderbottom main-for">
        		<input type="text" name="role_name" value="{{$arr[0]['role_name']}}" class="text-word">
        		<input type="hidden" name="role_id" value="{{$arr[0]['role_id']}}">
       		</td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
