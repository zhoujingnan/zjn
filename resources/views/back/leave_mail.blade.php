...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：留言管理&nbsp;&nbsp;>&nbsp;&nbsp;回复留言</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <form action="{{url('/backleave/sendmaildo')}}" enctype="multipart/form-data" method="post">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
    	<input type="hidden" name="_token" value="{{csrf_token()}}">
      	<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        	...
        	<input type="hidden" name="leave_id" value="{{$arr[0]['leave_id']}}">
        	<td align="left" valign="middle" class="borderright borderbottom main-for">
        		<input type="text" value="{{$arr[0]['leave_email']}}" class="text-word" disabled>
