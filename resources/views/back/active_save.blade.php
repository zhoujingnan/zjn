...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：活动管理&nbsp;&nbsp;>&nbsp;&nbsp;修改活动</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <form action="{{url('/backactive/updo')}}" enctype="multipart/form-data" method="post">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
    	<input type="hidden" name="_token" value="{{csrf_token()}}">
      	<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        	...
        	<input type="hidden" name="active_id" value="{{$arr[0]['active_id']}}">
        	<td align="left" valign="middle" class="borderright borderbottom main-for">
        		<input type="text" name="active_title" value="{{$arr[0]['active_title']}}" class="text-word">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        	...
        	<td align="left" valign="middle" class="borderright borderbottom main-for">
        		...
        		<img src="{{asset($arr[0]['active_img'])}}" alt="" width="150">
        		<input type="hidden" name="old_img" value="{{$arr[0]['active_img']}}">
        	</td>
       </tr>
	 <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        	<td align="right" valign="middle" class="borderright borderbottom bggray">	
        	...
        	<td align="left" valign="middle" class="borderright borderbottom main-for">
        		<input type="text" name="active_address" class="text-word" value="{{$arr[0]['active_address']}}">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        	...
        	<td align="left" valign="middle" class="borderright borderbottom main-for">
        		<input type="text" name="active_start_time" value="{{date('Y-m-d H:i',$arr[0]['active_start_time'])}}" class="text-word">
	  ...
	  <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        	...
        	<td align="left" valign="middle" class="borderright borderbottom main-for">
        		<input type="text" name="active_end_time" value="{{date('Y-m-d H:i',$arr[0]['active_end_time'])}}" class="text-word">
...
$(function(){
	...
	$("form").submit(function(){
		var active_title=$("[name='active_title']").val();
		var active_address=$("[name='active_address']").val();
		var active_start_time=$("[name='active_start_time']").val();
		var active_end_time=$("[name='active_end_time']").val();
		console.log(active_title);
		console.log(active_address);
		console.log(active_start_time);
		console.log(active_end_time);
		if(active_title&&active_address&&active_start_time&&active_end_time){
			return true;
		}else{
			return false;
		}
